...
const Header = () => {
  return (
    <div className='text-center'>
        ...
        <a
                href="#"
                className="rounded-md bg-sky-500 px-3.5 py-2.5 text-2xl font-normal text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-800">
                Call to action
              </a></div>
